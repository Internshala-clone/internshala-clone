  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        <h2 className="text-xl font-bold text-gray-900 mb-4">Official Email Id</h2>
        ...
        <form onSubmit={signUp}>
          ...
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Confirm Password</h2>
          <input
            type="password"
          ...
          <div className="flex gap-3">
            <div className="w-1/2">
              <h2 className="text-lg font-semibold text-gray-900 mb-2">First Name</h2>
              <input
                type="text"
                name="firstName"
            ...
            <div className="w-1/2">
              <h2 className="text-lg font-semibold text-gray-900 mb-2">Last Name</h2>
              <input
                type="text"
                name="lastName"
          ...
          <h2 className="text-lg font-semibold text-gray-900 mb-2">Mobile Number</h2>
          <div className="flex gap-3">
            <input
              type="text"
              value="+91"
