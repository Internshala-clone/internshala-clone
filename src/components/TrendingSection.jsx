...
const TrendingSection = () => {
  return (
    <section className="min-h-screen w-full flex flex-col justify-center items-center bg-gradient-to-r from-purple-600 to-indigo-700 text-white text-center z-10 pt-24">
      ...
      <div className="mt-12 mb-24"> {/* Added margin-bottom to ensure space at the bottom */}
        <a
          href="#explore"
